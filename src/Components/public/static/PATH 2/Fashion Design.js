  ...
  return (
    <div>
      <div className="WordSection1">
        ...
        >
          <b>MBA in Fashion Design Management</b>
        </p>
        <p
          className="MsoNormal"
          style={{ textAlign: "justify", textJustify: "inter-ideograph" }}
        >
          With economic growth, average income of Indians’ has increased. As a
          result, people with more disposable income can afford to spend more on
          their clothing. This has made Fashion Designing very popular in India
          over the last few years, and many people now consider it a career
          option.
        </p>
        <p
          className="MsoNormal"
          style={{ textAlign: "justify", textJustify: "inter-ideograph" }}
        >
          MBA in Fashion Designing deals with growing and sustaining the brand
          image and recognition of the product through media and advertising.
          This course is best suited for candidates with knowledge of fashion
          industry and business. Fashion Designing graduates have job
          opportunities in the field of fashion designing, multimedia,
        ...
        <p
          ...
          style={{ textAlign: "justify", textJustify: "inter-ideograph" }}
        >
          <b>MBA in Fashion Design Management – Program Highlights</b>
        </p>
        <table
            ...
            <tr>
              ...
              >
                ...
                <p
                  ...
                  style={{ marginBottom: "0in", lineHeight: "normal" }}
                >
                  Apparel Export Management and Merchandising
                </p>
              </td>
            </tr>
            <tr>
        ...
        <p
          ...
          style={{ textAlign: "justify", textJustify: "inter-ideograph" }}
        >
          <b>MBA in Fashion Design Management – Syllabus</b>
        </p>
        <p
          className="MsoNormal"
          style={{ textAlign: "justify", textJustify: "inter-ideograph" }}
        >
          MBA in Fashion Designing helps the students in becoming efficient and
          creative managers pertaining to fashion and fashion industry.
          Important subjects taught for MBA in Fashion Design Management are
          listed below:
        </p>
        <table
          className="MsoTableGrid"
          ...
          <tbody>
            ...
            <tr>
              ...
              >
                ...
                >
                  Portfolio Presentation and CAD
                </p>
              </td>
            </tr>
            <tr>
        ...
        <p
          ...
          style={{ textAlign: "justify", textJustify: "inter-ideograph" }}
        >
          <b>Top Colleges in India for MBA in Fashion Design Management</b>
        </p>
        <p
          className="MsoNormal"
          style={{ textAlign: "justify", textJustify: "inter-ideograph" }}
        >
          Fashion Design Management is a very niche specialisation and is
          offered by limited colleges across India. Some of the top colleges
          offering it are IIFT’s, MIT Institute of Design - Pune, AIBM-
          Faridabad, Cadence Academy of Design - Nagpur, Cindrebay School of
          Interior Design - Calicut, International Institute of Fashion Design-
          Pune. To find out about the top colleges of India offering MBA / PGDM
          in Fashion Design Management,
        ...
        <p
          ...
          style={{ textAlign: "justify", textJustify: "inter-ideograph" }}
        >
          Ans: MBA in Fashion Design course is best suited for candidates with
          knowledge of fashion industry. Fashion Designing graduates have job
          opportunities in the field of fashion designing, multimedia,
          clothing-line business, product management, and much more that
          restricting to media and entertainment.
        </p>
        ...
        <p
          ...
          style={{ textAlign: "justify", textJustify: "inter-ideograph" }}
        >
          Ans: Major components of study and skill development included with
          Fashion Design discipline are project accounting, design concepts
          focused on the user, creativity for transcending traditional
        ...
        <p
          ...
          style={{ textAlign: "justify", textJustify: "inter-ideograph" }}
        >
          Ans: The minimum eligibility criterion for MBA / PGDM in Fashion
          Design Management is graduation in any stream or equivalent from a
        ...
        <p
          ...
          style={{ textAlign: "justify", textJustify: "inter-ideograph" }}
        >
          Ans: In four semesters of MBA in Fashion Design Management students
          are taught Indian Fashion Scenario, Basic Concepts of Fashion Products
          and Manufacturing, Global Fashion Scenario, Apparel Production
          Planning and Control, e- Business and e-Commerce, Quality Management,
          Principles of Fashion Marketing and Merchandising, Portfolio
          Presentation and CAD, International Trade Operation and Documentation,
        ...
        <p
          ...
          style={{ textAlign: "justify", textJustify: "inter-ideograph" }}
        >
          Ans: Top colleges in India offering MBA in Fashion Design Management
          are IIFT’s, MIT Institute of Design - Pune, AIBM- Faridabad, Cadence
        ...
        <p
          ...
          style={{ textAlign: "justify", textJustify: "inter-ideograph" }}
        >
          Ans: The admission process of MBA in Fashion Design Management is same
          as other MBA specialisations, i.e. a candidate has to clear the
        ...
        <p
          ...
          style={{ textAlign: "justify", textJustify: "inter-ideograph" }}
        >
          Ans: An MBA in Fashion Designing graduate gets numerous job
          opportunities in the fields of clothing, film, fashion designing,
          brand marketing, advertising, social media, and much more. Some of the
          job roles offered are Apparel Production Manager, Costume Designer,
          Fabric Buyer, Fabric Quality Control Manager, Showroom Sales
        ...
        <p
          ...
          style={{ textAlign: "justify", textJustify: "inter-ideograph" }}
        >
          Ans: The average fees of an MBA in Fashion Design Management course in
        ...
        <p
          ...
          style={{ textAlign: "justify", textJustify: "inter-ideograph" }}
        >
          Ans: For admission in MBA in Fashion Design Management course, CAT,
          MAT, CMAT, XAT, GMAT, and ATMA scores are valid.
        </p>
      </div>
    </div>
  );
