...
const Signup = () => {
  return (
    <div> <header data-anim="fade" data-add-bg="" className="header -base js-header">
          ...
          <div className="col-auto">
            <div className="header-right d-flex items-center">
              ...
              <div className="header-menu js-mobile-menu-toggle ">
                <div className="header-menu__content">
                  ...
                  <div className="d-none xl:d-flex items-center px-20 py-20 border-bottom-light">
                    <a href="/login" className="text-dark-1">Log in</a>
                    <a href="/sig-nup" className="text-dark-1 ml-30">Sign Up</a>
                  </div>
                  ...
                  <div className="menu js-navList">
                    <ul className="menu__nav text-dark-1 -is-active">
                      <li className="menu-item-has-children">
                        ...
                        <ul className="subnav">
                          <li className="menu__backButton js-nav-list-back">
                            <a href="#"><i className="icon-chevron-left text-13 mr-10"></i> Home</a>
                          </li>
                      ...
                      <li className="menu-item-has-children -has-mega-menu">
                        <a data-barba href="#">Courses <i className="icon-chevron-right text-13 ml-10"></i></a>
                        ...
                        <ul className="subnav d-none xl:d-block">
                          <li className="menu__backButton js-nav-list-back">
                            <a href="#"><i className="icon-chevron-left text-13 mr-10"></i> Courses</a>
                          </li>

                          <li className="menu-item-has-children">
                            <a href="#">Course List Layouts<div className="icon-chevron-right text-11"></div></a>

                            <ul className="subnav">
                              <li className="menu__backButton js-nav-list-back">
                                <a href="#"><i className="icon-chevron-left text-13 mr-10"></i> Course List Layouts</a>
                              </li>
                          ...
                          <li className="menu-item-has-children">
                            <a href="#">Course Single Layouts<div className="icon-chevron-right text-11"></div></a>

                            <ul className="subnav">
                              <li className="menu__backButton js-nav-list-back">
                                <a href="#"><i className="icon-chevron-left text-13 mr-10"></i> Course Single Layouts</a>
                              </li>
                          ...
                          <li className="menu-item-has-children">
                            <a href="#">About Courses<div className="icon-chevron-right text-11"></div></a>

                            <ul className="subnav">
                              <li className="menu__backButton js-nav-list-back">
                                <a href="#"><i className="icon-chevron-left text-13 mr-10"></i> About Courses</a>
                              </li>
                          ...
                          <li className="menu-item-has-children">
                            <a href="#">Dashboard Pages<div className="icon-chevron-right text-11"></div></a>

                            <ul className="subnav">
                              <li className="menu__backButton js-nav-list-back">
                                <a href="#"><i className="icon-chevron-left text-13 mr-10"></i> Dashboard Pages</a>
                              </li>
                          ...
                          <li className="menu-item-has-children">
                            <a href="#">Popular Courses<div className="icon-chevron-right text-11"></div></a>

                            <ul className="subnav">
                              <li className="menu__backButton js-nav-list-back">
                                <a href="#"><i className="icon-chevron-left text-13 mr-10"></i> Popular Courses</a>
                              </li>
                      ...
                      <li className="menu-item-has-children">
                        <a data-barba href="#">Events <i className="icon-chevron-right text-13 ml-10"></i></a>
                        <ul className="subnav">
                          <li className="menu__backButton js-nav-list-back">
                            <a href="#"><i className="icon-chevron-left text-13 mr-10"></i> Events</a>
                          </li>
                      ...
                      <li className="menu-item-has-children">
                        <a data-barba href="#">Blog <i className="icon-chevron-right text-13 ml-10"></i></a>
                        <ul className="subnav">
                          <li className="menu__backButton js-nav-list-back">
                            <a href="#"><i className="icon-chevron-left text-13 mr-10"></i> Blog</a>
                          </li>
                      ...
                      <li className="menu-item-has-children">
                        ...
                        <ul className="subnav">
                          <li className="menu__backButton js-nav-list-back">
                            <a href="#"><i className="icon-chevron-left text-13 mr-10"></i> Pages</a>
                          </li>
                          <li className="menu-item-has-children">
                            <a href="#">About Us<div className="icon-chevron-right text-11"></div></a>

                            <ul className="subnav">
                              <li className="menu__backButton js-nav-list-back">
                                <a href="#"><i className="icon-chevron-left text-13 mr-10"></i> About Us</a>
                              </li>
                          ...
                          <li className="menu-item-has-children">
                            <a href="#">Contact<div className="icon-chevron-right text-11"></div></a>
                            <ul className="subnav">
                              <li className="menu__backButton js-nav-list-back">
                                <a href="#"><i className="icon-chevron-left text-13 mr-10"></i> Contact</a>
                              </li>
                          ...
                          <li className="menu-item-has-children">
                            <a href="#">Shop<div className="icon-chevron-right text-11"></div></a>
                            <ul className="subnav">
                              <li className="menu__backButton js-nav-list-back">
                                <a href="#"><i className="icon-chevron-left text-13 mr-10"></i> Shop</a>
                              </li>
              ...
              <div className="header-right__buttons md:d-none">
                <a href="/sign-up" className="button -sm -rounded -dark-1 text-white">Sign Up</a>
              </div>
            </div>
          </div>
      ...
      <section className="form-page">
        <div className="form-page__img bg-dark-1">
          <div className="form-page-composition">
            ...
            <div className="-el-2"><img data-move="40" className="js-mouse-move" src="img/general/1.png" alt="icon" /></div>
            <div className="-el-3"><img data-move="40" className="js-mouse-move" src="img/general/2.png" alt="icon" /></div>
            <div className="-el-4"><img data-move="40" className="js-mouse-move" src="img/general/3.png" alt="icon" /></div>
          </div>
        </div>
            ...
            <div className="row justify-center items-center">
              <div className="col-xl-8 col-lg-9">
                <div className="px-50 py-50 md:px-25 md:py-25 bg-white shadow-1 rounded-16">
                  ...
                  <p className="mt-10">Already have an account? <a href="/login" className="text-purple-1">Log in</a></p>
